...
/**
 * the script below a program that displays the information 
 ...
 * print_version - Printer to the version of an ELF header.
 **/
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
...
/**
 * @e_ident: Apointer to the array containing the ELF version.
 * print_osabi - Printer the OS/ABI of an ELF header.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
...
/**
 * @e_ident: points to an array containing the ELF class.
 * print_type - A Printer the type of an ELF header.
 * @e_type: The ELF type.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * main - Displays the content contained in the
